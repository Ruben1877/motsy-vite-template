...
if (typeof window !== "undefined") {
  ...
  if (window.parent !== window) {
    // Note Étape 2.1.5.2 — le wheel forwarding postMessage motsy:wheel
    // (Phase 2.1.5.1 Bug #3) a été retiré : le parent canvas-frame
    // utilise désormais un shield overlay (.frame-shield) avec iframe
    // pointer-events:none, qui capture nativement les wheel events sans
    // avoir besoin de postMessage. Pattern Webflow Designer / Framer.
